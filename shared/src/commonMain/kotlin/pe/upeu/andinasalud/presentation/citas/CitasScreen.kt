...
@Composable fun CitasScreen(estado: CitasUiState,visibles: List<Cita>,buscar:(String)->Unit,filtrar:(String)->Unit,reintentar:()->Unit,solicitar:()->Unit,detalle:(Int)->Unit) {
 ...
 item { Button(onClick=solicitar,modifier=Modifier.fillMaxWidth()){Text("Solicitar cita")} }
