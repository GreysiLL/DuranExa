...
- Evidencia-Git-AndinaSalud.pdf: captura real de la terminal de Android Studio con shortlog y el gráfico de ramas, incluida la etiqueta publicada.
...
La estudiante ejecutó el script y publicó la entrega: main b9afec2 y etiqueta v1.0-unidad1. La evidencia y guía de defensa añadidas después constituyen un complemento documental; no modifican el código de esa etiqueta.
...
- La captura real de shortlog ya está incorporada en Evidencia-Git-AndinaSalud.pdf y GIT-FINAL/shortlog-terminal-real.png.
